...
Provides utilities for managing copyright headers of `The NESTEGG
...
NESTEGG-Project/NESTEGG repository.
...
Configuring the github-merge tool for the NESTEGG repository is done in the following way:
    ...
    git config githubmerge.repository NESTEGG-Project/NESTEGG
