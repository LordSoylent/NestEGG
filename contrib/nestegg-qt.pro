...
RESOURCES += src/qt/nestegg.qrc src/qt/nestegg_locale.qrc

TRANSLATIONS += src/qt/locale/nestegg_bg.ts \
                src/qt/locale/nestegg_de.ts \
                src/qt/locale/nestegg_en.ts \
                src/qt/locale/nestegg_es.ts \
                src/qt/locale/nestegg_fi.ts \
                src/qt/locale/nestegg_fr.ts \
                src/qt/locale/nestegg_it.ts \
                src/qt/locale/nestegg_ja.ts \
                src/qt/locale/nestegg_pl.ts \
                src/qt/locale/nestegg_pt.ts \
                src/qt/locale/nestegg_ru.ts \
                src/qt/locale/nestegg_sk.ts \
                src/qt/locale/nestegg_sv.ts \
                src/qt/locale/nestegg_vi.ts \
                src/qt/locale/nestegg_zh_CN.ts \
                src/qt/locale/nestegg_zh_TW.ts
