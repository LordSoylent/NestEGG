...
COIN_GETDMN='https://github.com/SirElven8/NestEGG/releases/download/v1.4.0.1/nesteggd'
COIN_GETCLI='https://github.com/SirElven8/NestEGG/releases/download/v1.4.0.1/nestegg-cli'
COIN_NAME='NestEGG'
