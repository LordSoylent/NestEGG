...
from test_framework.nestegg_node import NestEggTestNode
...
class NESTEGG_ColdStakingTest(NestEggTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(NestEggTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 EGG from the pot)
