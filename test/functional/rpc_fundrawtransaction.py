...
class RawTransactionsTest(NestEggTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid nestegg address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid nestegg address" in e.error['message'])
