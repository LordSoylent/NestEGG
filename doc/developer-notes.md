...
Run with the `-testnet` option to run with "play EGGs (tEGG)" on the test network, if you
...
([`valgrind.supp`](https://github.com/nestegg-project/nestegg/blob/master/contrib/valgrind.supp))
...
# A coverage report will now be accessible at `./test_nestegg.coverage/index.html`.
```
...
- BitcoinMiner : Generates EGGs (if wallet is enabled).
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:NESTEGG-Project/NESTEGG.git
