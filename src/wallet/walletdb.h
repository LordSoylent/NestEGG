...
public:
    ...
    bool WriteZEGGSeed(const uint256& hashSeed, const std::vector<unsigned char>& seed);
    bool ReadZEGGSeed(const uint256& hashSeed, std::vector<unsigned char>& seed);
    bool ReadZEGGSeed_deprecated(uint256& seed);
    bool EraseZEGGSeed();
    bool EraseZEGGSeed_deprecated();

    bool WriteZEGGCount(const uint32_t& nCount);
    bool ReadZEGGCount(uint32_t& nCount);
