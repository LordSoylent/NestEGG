// Copyright (c) 2017-2018 The NESTEGG developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef NESTEGG_ZEGGWALLET_H
#define NESTEGG_ZEGGWALLET_H
...
public:
    CzEGGWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZEGG(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZEGG(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
