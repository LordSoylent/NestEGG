...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NESTEGG features */
        {"nestegg", "listmasternodes", &listmasternodes, true, true, false},
        {"nestegg", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nestegg", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nestegg", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"nestegg", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"nestegg", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"nestegg", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nestegg", "masternodedebug", &masternodedebug, true, true, false},
        {"nestegg", "startmasternode", &startmasternode, true, true, false},
        {"nestegg", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nestegg", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nestegg", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nestegg", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nestegg", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nestegg", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nestegg", "preparebudget", &preparebudget, true, true, false},
        {"nestegg", "submitbudget", &submitbudget, true, true, false},
        {"nestegg", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nestegg", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nestegg", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nestegg", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nestegg", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nestegg", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nestegg", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nestegg", "checkbudgets", &checkbudgets, true, true, false},
        {"nestegg", "mnsync", &mnsync, true, true, false},
        {"nestegg", "spork", &spork, true, true, false},
        {"nestegg", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzeggseed", &getzeggseed, false, false, true},
        {"zerocoin", "setzeggseed", &setzeggseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzegg", &searchdzegg, false, false, true},
        {"zerocoin", "dzeggstate", &dzeggstate, false, false, true},
