...
#ifndef NESTEGG_CORE_NEW_GUI_NESTEGGGUI_H
#define NESTEGG_CORE_NEW_GUI_NESTEGGGUI_H
...
*/
class NESTEGGGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit NESTEGGGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~NESTEGGGUI();
...
#endif //NESTEGG_CORE_NEW_GUI_NESTEGGGUI_H
