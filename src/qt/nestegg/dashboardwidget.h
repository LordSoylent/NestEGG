...
#include "qt/nestegg/furabstractlistitemdelegate.h"
...
#include "config/nestegg-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalEgg = 0;
    qint64 totalZegg = 0;
    QList<qreal> valuesEgg;
    QList<qreal> valueszEgg;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(NESTEGGGUI* _window);
    ~DashboardWidget();
