...
#include "qt/nestegg/coincontroleggwidget.h"
#include "qt/nestegg/forms/ui_coincontroleggwidget.h"

CoinControlEggWidget::CoinControlEggWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlEggWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select EGG Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("EGG");
    ...
    ui->labelValueAfter->setText("0.00 EGG");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 EGG");
    ui->labelValueFee->setText("0.00 EGG");
...
CoinControlEggWidget::~CoinControlEggWidget()
{
    delete ui;
}
