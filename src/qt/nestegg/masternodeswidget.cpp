...
#include "qt/nestegg/forms/ui_masternodeswidget.h"
#include "qt/nestegg/qtutils.h"
#include "qt/nestegg/mnrow.h"
#include "qt/nestegg/mninfodialog.h"

#include "qt/nestegg/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(NESTEGGGUI *parent) :
    PWidget(parent),
...
bool MasterNodesWidget::startMN(CMasternodeConfig::CMasternodeEntry mne, std::string& strError) {
    ...
    if (!activeMasternode.CreateBroadcast(mne.getIp(), mne.getPrivKey(), mne.getTxHash(), mne.getOutputIndex(), strError, mnb))
        return false;
