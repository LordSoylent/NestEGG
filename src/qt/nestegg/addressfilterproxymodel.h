...
#ifndef NESTEGG_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define NESTEGG_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //NESTEGG_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
