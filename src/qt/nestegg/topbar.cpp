...
#include "qt/nestegg/topbar.h"
#include "qt/nestegg/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/nestegg/lockunlock.h"
#include "qt/nestegg/qtutils.h"
#include "qt/nestegg/receivedialog.h"
...
TopBar::TopBar(NESTEGGGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopEgg, ui->labelAmountTopzEgg}, "amount-small-topbar");
    setCssProperty({ui->labelAmountEgg, ui->labelAmountzEgg}, "amount-topbar");
    setCssProperty({ui->labelPendingEgg, ui->labelPendingzEgg, ui->labelImmatureEgg, ui->labelImmaturezEgg}, "amount-small-topbar");
...
void TopBar::updateBalances(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance,
    ...
    // EGG Total
    CAmount eggAvailableBalance = balance;
    // zEGG Balance
    CAmount matureZerocoinBalance = zerocoinBalance - unconfirmedZerocoinBalance - immatureZerocoinBalance;

    // Set
    QString totalEgg = GUIUtil::formatBalance(eggAvailableBalance, nDisplayUnit);
    QString totalzEgg = GUIUtil::formatBalance(matureZerocoinBalance, nDisplayUnit, true);
    // Top
    ui->labelAmountTopEgg->setText(totalEgg);
    ui->labelAmountTopzEgg->setText(totalzEgg);

    // Expanded
    ui->labelAmountEgg->setText(totalEgg);
    ui->labelAmountzEgg->setText(totalzEgg);

    ui->labelPendingEgg->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelPendingzEgg->setText(GUIUtil::formatBalance(unconfirmedZerocoinBalance, nDisplayUnit, true));

    ui->labelImmatureEgg->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
    ui->labelImmaturezEgg->setText(GUIUtil::formatBalance(immatureZerocoinBalance, nDisplayUnit, true));
}
