...
#include "qt/nestegg/coldstakingwidget.h"
#include "qt/nestegg/forms/ui_coldstakingwidget.h"
#include "qt/nestegg/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/nestegg/requestdialog.h"
#include "qt/nestegg/tooltipmenu.h"
#include "qt/nestegg/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(NESTEGGGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your EGGs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept EGG delegation / Delegate EGG"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select EGG outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 EGG" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
