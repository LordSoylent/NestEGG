...
#include "qt/nestegg/forms/ui_receivewidget.h"
...
#include "qt/nestegg/addressholder.h"
...
ReceiveWidget::ReceiveWidget(NESTEGGGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive EGG."));
