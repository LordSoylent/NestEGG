...
#include "qt/nestegg/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/nestegg/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(NESTEGGGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to NESTEGGGUI::handleRestart()
