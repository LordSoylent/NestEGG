...
#include "qt/nestegg/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/nestegg/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(NESTEGGGUI* _window, QWidget *parent) :
