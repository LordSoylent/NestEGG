...
#include "qt/nestegg/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/nestegg/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(NESTEGGGUI* _window, QWidget *parent) :
