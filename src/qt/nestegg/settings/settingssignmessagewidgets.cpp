...
#include "qt/nestegg/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(NESTEGGGUI* _window, QWidget *parent) :
