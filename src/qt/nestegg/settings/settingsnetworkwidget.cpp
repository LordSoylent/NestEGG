...
#include "qt/nestegg/settings/settingsnetworkwidget.h"
#include "qt/nestegg/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/nestegg/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(NESTEGGGUI* _window, QWidget *parent) :
