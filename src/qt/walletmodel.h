...
#ifndef NESTEGG_QT_WALLETMODEL_H
#define NESTEGG_QT_WALLETMODEL_H
...
/** Interface to NESTEGG wallet from Qt view code. */
...
#endif // NESTEGG_QT_WALLETMODEL_H
