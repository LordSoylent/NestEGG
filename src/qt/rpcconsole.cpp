                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzEGGPathCustom = GetArg("-zeggbackuppath", "");
    ...
    if(!strzEGGPathCustom.empty()) {
        ui->wallet_customzeggbackuppath->setText(QString::fromStdString(strzEGGPathCustom));
        ui->wallet_customzeggbackuppath_label->setVisible(true);
        ui->wallet_customzeggbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzEGGPathCustom.empty()) && nCustomBackupThreshold > 0) {
