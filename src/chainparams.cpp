...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (56689, uint256("87dfee75b1b31f99e3740b1dbe5593c4fb5d704f3e53f7644a52fde54d1a1a47"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1596691888, // * UNIX timestamp of last checkpoint block
    58097,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04fce085132a8f8dea9311ba40177ed8f5b9db518f796b03365d66677124808f37958d91cc8c5afa984b6941cd47f751817d4c1af2b20b9cd8aec61c863229472b");
        nDefaultPort = 20434;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // NESTEGG starting difficulty is 1 / 2^12
        ...
        nTargetTimespan_V2 =  nTimeSlotLength * 30;     // 7.5 minutes
        nMaturity = 20;
        ...
        // Blocks v7
        nBlockLastAccumulatorCheckpoint = 54747;
        nBlockV7StartHeight = nBlockTimeProtocolV2;

        // Fake Serial Attack
        nFakeSerialBlockheightEnd = 54000;
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("041b6ae881f73d69ce727636b0627d9fdba2c98ceffacf865409828ba8ee834684581ce0119c19a9197ac99f8c90bc6b45a964d21f76983f4a8b7e0b418a8d5efc") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = BlockMerkleRoot(genesis);
        genesis.nVersion = 1;
        genesis.nTime = 1593067522;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 22333198;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000000fe0f6f6f7f005bb1373daebbff98b69a2c2376efb7ea9b86ce4bea7d72"));
        assert(genesis.hashMerkleRoot == uint256("0x6ec31ff0ff13142c02dff7da188167ef9bb2adc8b7b646b2d1b859c31be062cc"));

        vSeeds.push_back(CDNSSeedData("207.148.24.94", "207.148.24.94"));
        vSeeds.push_back(CDNSSeedData("149.28.205.121", "149.28.205.121"));
        vSeeds.push_back(CDNSSeedData("136.244.67.15", "136.244.67.15"));
        vSeeds.push_back(CDNSSeedData("45.77.133.78", "45.77.133.78"));
        vSeeds.push_back(CDNSSeedData("207.148.1.73", "207.148.1.73"));
        vSeeds.push_back(CDNSSeedData("139.180.170.177", "139.180.170.177"));
        ...
        strSporkPubKey = "049bdce9639a10c815c3d9213b77401512046031b73e78ef880e9e4abedc28c665da7a04eb5c98b3e8685cf7782ec45cd431e6dec8fe575b6ac7cdd5109812e10f";
        ...
        strObfuscationPoolDummyAddress = "EWaFb6QmUASw2YAcJe2Gjpd1oscyaPQDzU";
        nStartMasternodePayments = 1593067522; //Wed, 25 Jun 2014 20:36:16 GMT
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zegg to be stakable
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nNestEggBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nNestEggBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "nestegg-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "nestegg-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("warrows.dev", "testnet.dnsseed.nestegg.warrows.dev"));
        ...
        // Testnet nestegg BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet nestegg BIP32 prvkeys start with 'DRKP'
